...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    // //Phase 3
    // string downloaddirstr = "files/client" + to_string(clientid)+ "/Downloaded";
    ...
    //                             string filepath  = "files/client" + to_string(clientid) + "/Downloaded/" + filestoask2[i][filereceiving];
    ...
    //                         }
    //                         x++;
    //                         temp = "files/client" + to_string(clientid) + "/" + temp;
    ...
    //     else
    //     {
    //         string path = "files/client"+ to_string(clientid) + "/Downloaded/" + filenamestosearch[i];
                    ...
                    while (filereceiving < cnt) {
                        if (sizesoffiles[filereceiving] == 0) {
                            ...
                            if (recvsize > 0) {
                                ...
                                int remainingdata = stoi(temp);
                                string filepath  = "files/client" + to_string(clientid) + "/Downloaded/" + filestoask2new[i][filereceiving];
                                FILE* filepathdesc = fopen(filepath.c_str(), "w");
                                int rb = 0;
                                while (remainingdata > 0) {
